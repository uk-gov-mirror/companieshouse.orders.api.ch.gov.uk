...
public class CheckoutToPaymentDetailsMapperTest {
    ...
    static {
        ...
        DESC_VALUES.put(DESC_IDENTIFIER, COMPANY_NUMBER);
        ITEM.setId(ITEM_ID);
    ...
    private void testItems(Checkout source, PaymentDetailsDTO target){
        ...
        assertThat(target.getItems().get(0).getDescriptionValues().get(DESC_IDENTIFIER), is(COMPANY_NUMBER));
        assertThat(target.getItems().get(0).getDescription(), is(COMPANY_NUMBER));
        ...
        assertThat(target.getItems().get(1).getDescriptionValues().get(DESC_IDENTIFIER), is(COMPANY_NUMBER));
        assertThat(target.getItems().get(1).getDescription(), is(COMPANY_NUMBER));
        ...
        assertThat(target.getItems().get(2).getDescriptionValues().get(DESC_IDENTIFIER), is(COMPANY_NUMBER));
        assertThat(target.getItems().get(2).getDescription(), is(COMPANY_NUMBER));
